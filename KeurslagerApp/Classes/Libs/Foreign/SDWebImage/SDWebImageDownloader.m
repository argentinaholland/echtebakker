...
const NSTimeInterval kSDWebImageDownloaderTimeoutInterval = 15;
...
- (void)start
{
	...
	NSURLRequest *request = [[NSURLRequest alloc] initWithURL:url cachePolicy:NSURLRequestReloadIgnoringLocalCacheData timeoutInterval:kSDWebImageDownloaderTimeoutInterval];
